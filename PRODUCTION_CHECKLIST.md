...
- [ ] Android release workflow resolves the intended HTTPS UI origin through `ANDROID_APP_URL` or its reviewed production default, and has `ANDROID_KEYSTORE_BASE64`, `ANDROID_KEYSTORE_PASSWORD`, `ANDROID_KEY_ALIAS`, and `ANDROID_KEY_PASSWORD` configured.
