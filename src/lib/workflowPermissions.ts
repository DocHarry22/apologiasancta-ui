...
export function canViewWorkflowItem(role: Role, userId: string, item: WorkflowPermissionItem): boolean {
...
export function canEditWorkflowItem(role: Role, userId: string, item: WorkflowPermissionItem): boolean {
...
export function canSubmitWorkflowItem(role: Role, userId: string, item: WorkflowPermissionItem): boolean {
...
export function canReviewWorkflowItem(role: Role, userId: string, item: WorkflowPermissionItem): boolean {
